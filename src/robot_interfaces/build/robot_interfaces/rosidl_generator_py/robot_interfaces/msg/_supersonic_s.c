...
bool robot_interfaces__msg__supersonic__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._supersonic.Supersonic", full_classname_dest, 43) == 0);
  }
  robot_interfaces__msg__Supersonic * ros_message = _ros_message;
  {  // header
...
PyObject * robot_interfaces__msg__supersonic__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._supersonic");
