...
def generate_launch_description():
    robot_description_path = get_package_share_path('rm_description')
    model_path = robot_description_path / 'urdf/s300_mini.xacro'
    default_rviz_config_path = robot_description_path / 'rviz/rm_eco65.rviz'
